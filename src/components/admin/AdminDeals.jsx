            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <label
                    htmlFor="memo-upload-add"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 flex items-center justify-center gap-2 text-sm"
                  >
                    <Upload size={16} />
                    {uploadingMemo ? 'Uploading...' : form.memoUrl ? 'Change File' : 'Upload File'}
                  </label>
                  {form.memoUrl && (
                    <a href={form.memoUrl} target="_blank" rel="noopener noreferrer" className="px-3 py-2 border border-blue-300 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 flex items-center">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    type="file"
                    accept=".pdf,.ppt,.pptx,.xlsx,.xls"
                    onChange={handleDeckUpload}
                    className="hidden"
                    id="deck-upload-add"
                  />
                  <label
                    htmlFor="deck-upload-add"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 flex items-center justify-center gap-2 text-sm"
                  >
                    <Upload size={16} />
                    {uploadingDeck ? 'Uploading...' : form.deckUrl ? 'Change File' : 'Upload File'}
                  </label>
                  {form.deckUrl && (
                    <a href={form.deckUrl} target="_blank" rel="noopener noreferrer" className="px-3 py-2 border border-purple-300 bg-purple-50 text-purple-600 rounded-lg hover:bg-purple-100 flex items-center">
                      <ExternalLink size={16} />
                    </a>
                  )}
                </div>
              ...
              <div>
                ...
                {form.additionalMedia.length > 0 && (
                  <div className="space-y-2">
                    {form.additionalMedia.map((media, index) => (
                      <div
                        key={index}
                        draggable
                        onDragStart={handleMediaDragStart(index)}
                        onDragOver={handleMediaDragOver(index)}
                        onDragLeave={handleMediaDragLeave(index)}
                        onDrop={handleMediaDrop(index)}
                        onDragEnd={handleMediaDragEnd}
                        className={`grid grid-cols-[auto_1fr_1fr] gap-2 items-center rounded-lg ${
                          dragOverMediaIndex === index ? 'ring-2 ring-blue-400 ring-offset-1' : ''
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <input
                            type="file"
                            accept=".pdf,.doc,.docx,.ppt,.pptx,.xlsx,.xls,.jpg,.jpeg,.png"
                            onChange={(e) => handleAdditionalMediaUpload(index, e)}
                            className="hidden"
                            id={`additional-upload-add-${index}`}
                          />
                          <label
                            htmlFor={`additional-upload-add-${index}`}
                          ...
                          {media.url && (
                            <a href={media.url} target="_blank" rel="noopener noreferrer" className="px-3 py-2 border border-green-300 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 flex items-center">
                              <ExternalLink size={16} />
                            </a>
                          )}
                          <button
                            ...
                            className="px-3 py-2 border border-red-300 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 flex items-center"
                          >
                            <Trash2 size={16} />
                          </button>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            onChange={(e) => handleAdditionalMediaUpload(index, e)}
                            className="hidden"
                            id={`additional-upload-edit-${index}`}
                          />
                          <label
                            htmlFor={`additional-upload-edit-${index}`}
                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 flex items-center gap-2 justify-center text-sm"
                          >
                            <Upload size={14} />
                            {uploadingAdditional[index] ? 'Uploading...' : media.url ? 'Change' : 'Upload'}
